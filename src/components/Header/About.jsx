...
const About = () => {
    const imageu='https://img.freepik.com/free-photo/group-people-working-out-business-plan-office_1303-15866.jpg?w=996&t=st=1696349892~exp=1696350492~hmac=a86861d75042b1a656853fcbd8b14da227bfbdf58aa697b6d912c917e73eed7b'
  return (
    
    <div className="row contactus m-4 p-4">
        <div className="col-md-6">
          <img
            src={imageu} // Path: public\images\about.jpeg
            alt="contactus"
            style={{ width: "100%" }}
          />
        </div>
        <div className="col-md-6">
          <div>
            <h2>AgriMarket: Empowering Farmers in the Digital Era</h2>
            <p>
              <br></br>
